...
<div class="pull-right">
	<a href="<?php echo site_url('menu_olah/add'); ?>" class="btn btn-success">Add</a> 
</div>
...
<table class="table table-striped table-bordered">
	...
	<?php foreach($menu_olah as $m){ ?>
    <tr>
		<td><?php echo $m['id']; ?></td>
		<td><?php echo $m['nama_olahan']; ?></td>
		<td><?php echo $m['Jumlah_Olahan']; ?></td>
		<td>
            <a href="<?php echo site_url('menu_olah/edit/'.$m['id']); ?>" class="btn btn-info btn-xs">Edit</a> 
            <a href="<?php echo site_url('menu_olah/remove/'.$m['id']); ?>" class="btn btn-danger btn-xs">Delete</a>
        </td>
    </tr>
	<?php } ?>
</table>
