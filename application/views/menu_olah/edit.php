				...
				<section class="section">
					...
					<div class="section-body">
						<div class="card">
							...
							<div class="card-body">
<?php echo form_open('menu_olah/edit/'.$menu_olah['id'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="nama_olahan" class="col-md-4 control-label">Nama Olahan</label>
		<div class="col-md-8">
			<input type="text" name="nama_olahan" value="<?php echo ($this->input->post('nama_olahan') ? $this->input->post('nama_olahan') : $menu_olah['nama_olahan']); ?>" class="form-control" id="nama_olahan" />
		</div>
	</div>
	<div class="form-group">
		<label for="Jumlah_Olahan" class="col-md-4 control-label">Jumlah Olahan</label>
		<div class="col-md-8">
			<input type="text" name="Jumlah_Olahan" value="<?php echo ($this->input->post('Jumlah_Olahan') ? $this->input->post('Jumlah_Olahan') : $menu_olah['Jumlah_Olahan']); ?>" class="form-control" id="Jumlah_Olahan" />
		</div>
	</div>
