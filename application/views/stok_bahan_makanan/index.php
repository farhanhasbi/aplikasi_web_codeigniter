					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Daftar Stok Bahan Makanan</h4>
							</div>
							<div class="card-body">
<div class="pull-right">
	 <a href="<?php echo site_url('stok_bahan_makanan/add'); ?>" class="btn btn-success"><i class="fas fa-plus"></i> Add</a> 
</div>

<a href="<?php echo site_url("stok_bahan_makanan/export"); ?>" class="btn btn-primary">Export ke Excel</a><br><br>

<a href="<?php echo site_url("stok_bahan_makanan/cetak"); ?>" class="btn btn-secondary" >Cetak Data</a><br><br>

<table class="table table-striped table-bordered mt-3" id="table" >
	<thead>
    <tr>
		<th width="300" class="text-center">ID</th>
		<th width="550">Nama Bahan</th>
		<th width="400">Kelompok Bahan</th>
		<th width="550">Jumlah Bahan</th>
		<th width="550">Modify</th>
    </tr>
    </thead>
    <tbody>
	</tbody>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('stok_bahan_makanan/ajax_list')?>",
            "type": "POST"
        },
