					...
					<div class="section-body">
						<div class="card">
							<div class="card-header">
								<h4>Tambah Data Stok Bahan Makanan</h4>
							</div>
							<div class="card-body">
<?php echo form_open('stok_bahan_makanan/add',array("class"=>"form-horizontal")); ?>
	<div class="form-group">
		<label for="nama_bahan" class="col-md-4 control-label"><span class="text-danger"></span>Nama Bahan</label>
		<div class="col-md-8">
			<input type="text" name="nama_bahan" value="<?php echo $this->input->post('nama_bahan'); ?>" class="form-control" id="nama_bahan" />
	...
	<div class="form-group">
		...
		<div class="col-md-8" >
			<select name="kelompok_bahan" class="form-control" style="height: 42px;">
				<option value="">select kelompok_bahan_makanan</option>
				<?php 
				foreach($all_kelompok_bahan_makanan as $kelompok_bahan_makanan)
				{
					$selected = ($kelompok_bahan_makanan['id_kel'] == $this->input->post('kelompok')) ? ' selected="selected"' : "";
