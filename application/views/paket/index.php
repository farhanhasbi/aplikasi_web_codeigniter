...
<div class="pull-right">
	<a href="<?php echo site_url('paket/add'); ?>" class="btn btn-success" style="margin-bottom: 15px;">Add</a> 
</div>

<a href="<?php echo site_url("paket/export"); ?>" class="btn btn-primary">Export ke Excel</a><br><br>

<a href="<?php echo site_url("paket/cetak"); ?>" class="btn btn-secondary" >Cetak Data</a><br><br>
...
<table class="table table-striped table-bordered mt-3" id="myTable">
    ...
    <tr>
		...
		<th width="550" class="text-center">Menu</th>
		<th width="200">Jadwal</th>
		<th width="350">Modify</th>
    </tr>
    </thead>
    <tbody>
	</tbody>
