...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'dogtooth567@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Charlotte Katakuri'; // Isikan dengan nama pengirim
    protected $password = 'jixblpmgomockbrs'; // Isikan dengan password email pengirim
